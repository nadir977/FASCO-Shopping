...
const SignIn = () => {
  return (
    <div className="w-screen min-h-screen flex items-center justify-center">
      <div className="w-full h-full md:w-[80%] md:h-[80%] border border-[#DBDBDB] flex flex-col md:flex-row md:rounded-r-xl overflow-hidden">
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-between">
          <div className="flex flex-col py-4 px-6 md:px-16">
            ...
            <div className="flex flex-col md:flex-row gap-6">
              <button className="flex items-center justify-center gap-2 border rounded-lg px-6 py-1 cursor-pointer border-[#5B86E5] hover:bg-[#5B86E5]/10 transition">
                <img src={image23} alt="Google" />
                <p>Sign up with Google</p>
              </button>

              <button className="flex items-center justify-center gap-2 border rounded-lg px-6  md:py-1 cursor-pointer border-[#5B86E5] hover:bg-[#5B86E5]/10 transition">
                <img src={image24} alt="Email" />
           ...
           <div className="flex flex-col gap-6 mb-10">
            ...
            <div className="flex flex-col px-4 gap-4">
              <div>
                <button className="w-full bg-black hover:bg-[#333] shadow-[0px_20px_35px_0px_#00000026] text-white py-3 rounded-lg cursor-pointer">
                  Sign In
                </button>
              </div>
              ...
              <div className="w-full flex cursor-pointer text-[#5B86E5] justify-center md:justify-end ">
                <Link to="/ForgotPassword" className="text-[#5B86E5] hover:underline font-[700]">
                  Forgot Password?
                </Link>
              </div>
            </div>

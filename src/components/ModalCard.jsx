...
const ModalCard = ({ open, onClose }) => {
  ...
  return (
    <div
      ...
      aria-modal="true"
    >
      <div className="w-full max-w-full sm:mr-12 sm:max-w-[700px] bg-white h-full shadow-xl flex flex-col animate-slideIn">
        
        <div className="flex justify-between items-center px-6 sm:px-10 pt-4">
          <h1 className="text-[28px] sm:text-[42px] Instagram_h1">Shopping Cart</h1>
          <button
          ...
          <div className="flex gap-4 py-5 border-b border-[#00000063]">
            ...
            <div className="flex flex-col p-2 gap-4 w-full">
              <div className="flex flex-col gap-1">
                ...
                <p className="text-[22px] mt-1">$14.80</p>
              </div>
              <div className="flex items-center w-[130px] sm:w-[170px] bg-[#F1F1F1] rounded justify-between">
                <button onClick={decrement} className="px-3 text-[35px] cursor-pointer">
                  -
                </button>
                <span className="px-3 text-xl text-[#8A8A8A]">{quantity}</span>
                <button onClick={increment} className="px-3 text-2xl cursor-pointer">
                  +
                </button>
              </div>
            </div>

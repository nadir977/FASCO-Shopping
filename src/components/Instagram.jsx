...
const Instagram = () => {
  return (
    <div className="flex flex-col items-center bg-[#FAFAFA] pt-10 mb-10 md:pt-32 md:mb-32">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-7 items-center gap-1  md:gap-0">
        <div className="w-full h-full sm:h-[300px] overflow-hidden">
          <img
            src={image5}
            alt="image"
        ...
        <div className="w-full h-full sm:h-[350px] overflow-hidden">
          <img
            src={image6}
            alt="image"
            className="w-full h-full object-cover"

...
const SignIn = () => {
  ...
  <button className="flex items-center justify-center gap-2 border rounded-lg px-6 py-2 cursor-pointer border-[#5B86E5] hover:bg-[#5B86E5]/10 transition w-full md:w-auto min-w-[200px]">
    ...
    <p className="text-sm md:text-base lg:text-lg font-medium whitespace-nowrap">
      Sign up with Email
        ...
        <div className="flex items-center justify-center my-6">
          <div className="flex-1 h-[2px] max-w-[30px] bg-[#838383]" />
          <p className="mx-4 text-[#838383] font-[700] text-[20px] md:text-[30px]">OR</p>
          <div className="flex-1 h-[2px] max-w-[30px] bg-[#838383]" />
        </div>
